...
public class FunctionalItem {
    ...
    private FunctionalItem(ItemStack itemStack, Consumer<InventoryClickEvent> clickAction, FunctionalItemType type) {
     ...
     */
    public static FunctionalItem of(@NotNull ItemStack itemStack, @NotNull Consumer<InventoryClickEvent> clickAction) {
